...
> **Note:** The same 61 samples were used for both fine-tuning and evaluation due to dataset size constraints. Results reflect domain adaptation behaviour, not generalisable performance.
