...
# Use GPU if available (optional performance boost)
...
# Load ASR Outputs
# -------------------------------
# Predictions from different ASR models
...
wav2vec_lm = pd.read_csv(BASE_DIR / "results" / "wav2vec_lm.csv")  # with language model
...
df["wav2vec_lm_pred"] = wav2vec_lm["wav2vec_lm_pred"]
...
def translate(text):
    ...
    translated_tokens = model.generate(
        **inputs,
        # Force output language to Malay
...
models = [
    ...
    ("wav2vec_lm_pred", "wav2vec_lm")
]

# Ground truth Malay references
